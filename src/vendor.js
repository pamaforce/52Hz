...
var _platform = _interopRequireDefault(__webpack_require__(/*! ./libs/function/platform */ 136));
...
var pleaseSetTranspileDependencies = {},
    babelTest = pleaseSetTranspileDependencies === null || pleaseSetTranspileDependencies === void 0 ? void 0 : pleaseSetTranspileDependencies.test; // 引入全局mixin
...
/* WEBPACK VAR INJECTION */(function(uni) {module.exports = {
  ...
  methods: {
    ...
    getParentData: function getParentData() {
      ...
      if (!this.parent) this.parent = {}; // 这里的本质原理是，通过获取父组件实例(也即类似u-radio的父组件u-radio-group的this)
...
var _Request = _interopRequireDefault(__webpack_require__(/*! ./core/Request */ 18));
...
var _clone = _interopRequireDefault(__webpack_require__(/*! ../utils/clone */ 30));
...
var _index = _interopRequireDefault(__webpack_require__(/*! ../adapters/index */ 20));
...
var _buildURL = _interopRequireDefault(__webpack_require__(/*! ../helpers/buildURL */ 21));
...
var utils = _interopRequireWildcard(__webpack_require__(/*! ../utils */ 22));
...
var _combineURLs = _interopRequireDefault(__webpack_require__(/*! ../helpers/combineURLs */ 25));
...
var _default = function _default(globalsConfig) {
  ...
  config = _objectSpread(_objectSpread({}, config), mergeKeys(defaultToConfig2Keys, globalsConfig, config2)); // eslint-disable-next-line no-empty
...
var _default = clone;
exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../node-libs-browser/node_modules/buffer/index.js */ 31).Buffer))
...
var _index = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator/index.js */ 36));
...
var Router = /*#__PURE__*/function () {
  ...
  _createClass(Router, [{
    ...
    key: "route",
    value: function () {
      var _route = _asyncToGenerator( /*#__PURE__*/_index.default.mark(function _callee() {
        var options,
            params,
            mergeConfig,
            isNext,
...
function colorGradient() {
  ...
  for (var i = 0; i < step; i++) {
    // 计算每一步的hex值
    var hex = rgbToHex("rgb(".concat(Math.round(sR * i + startR), ",").concat(Math.round(sG * i + startG), ",").concat(Math.round(sB * i + startB), ")")); // 确保第一个颜色值为startColor的值

    if (i === 0) hex = rgbToHex(startColor); // 确保最后一个颜色值为endColor的值
...
function date(value) {
  if (!value) return false; // 判断是否数值或者字符串数值(意味着为时间戳)，转为数值，否则new Date无法识别字符串时间戳
...
function addStyle(customStyle) {
  ...
  if (_test.default.empty(customStyle) || _typeof(customStyle) === 'object' && target === 'object' || target === 'string' && typeof customStyle === 'string') {
    return customStyle;
  } // 字符串转对象
  ...
  if (target === 'object') {
    ...
    customStyle = trim(customStyle); // 根据";"将字符串转为数组形式

    var styleArray = customStyle.split(';');
    var style = {}; // 历遍数组，拼接成对象
...
function formValidate(instance, event) {
  ...
  var form = uni.$u.$parent.call(instance, 'u-form'); // 如果发生变化的input或者textarea等，其父组件中有u-form-item或者u-form等，就执行form的validate方法
...
function setProperty(obj, key, value) {
  ...
  var inFn = function inFn(_obj, keys, v) {
    ...
    while (keys.length > 1) {
      ...
      if (!_obj[k] || _typeof(_obj[k]) !== 'object') {
        _obj[k] = {};
      }

      var _key = keys.shift(); // 自调用判断是否存在属性，不存在则自动创建对象
...
var _upload = _interopRequireDefault(__webpack_require__(/*! ./props/upload */ 133));
...
/* 150 */
/*!************************************************************!*\
  !*** ./node_modules/uview-ui/components/u-navbar/props.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
